...
//@water del debug;
        ...
        try {
            ...
            Object sRuntime = get_runtime.invoke(null);
            Method  registerNativeAllocation = vm_runtime.getDeclaredMethod("registerNativeAllocation", Integer.TYPE);
            registerNativeAllocation.invoke(sRuntime, mEstimatedNativeAllocBytes);
        } catch (Exception e) {
            Log.e(TAG, "No GC methods");
        }
    ...
    public void close() {
        ...
        if (mEstimatedNativeAllocBytes > 0) {
            ...
            try {
                ...
                Method get_runtime = vm_runtime.getDeclaredMethod("getRuntime");
                Object sRuntime = get_runtime.invoke(null);
                Method  registerNativeFree = vm_runtime.getDeclaredMethod("registerNativeFree", Integer.TYPE);
                registerNativeFree.invoke(sRuntime, mEstimatedNativeAllocBytes);
            } catch (Exception e) {
                Log.e(TAG, "No GC methods");
            }

...
static void decodeJpegToYV12(uint8_t * jpegData, uint32_t srcSize, uint8_t * dstData,
    ...
    ALOGD("out.jpgHandle:%p,out.srcW:%d,out.srcH:%d,in.dstF:%d,in.dstW:%d,in.dstH:%d,in.srcL:%d",
            outInfo.jpgDecHandle, outInfo.srcWidth, outInfo.srcHeight, inParams.dstFormat,
...
static void com_mediatek_jpegdecoder_setup_surfacetexture(JNIEnv *env, jobject thiz,
    ...
    if (jsurfacetexture != NULL) {
        ...
        ALOGD("[%s]: Surface width:%d, height:%d, format:%d, nativeWindow:%p, ionDri_handle:%d",
...
const char *classPathName = "com/mediatek/camera/common/jpeg/HwJpegDecodeImpl";

JNINativeMethod methods[] = {
    {"nativeClassInit", "()V", (void*)com_mediatek_jpegdecoder_classInit},
    {"nativeSetup", "(Landroid/graphics/SurfaceTexture;)V",
                                             (void*)com_mediatek_jpegdecoder_setup_surfacetexture},
    {"nativeSetup", "(III[B)V", (void*)com_mediatek_jpegdecoder_setup_1},
    {"nativeDecode", "([B)V", (void*)com_mediatek_jpegdecoder_decode},
    {"nativeRelease", "()V", (void*)com_mediatek_jpegdecoder_release},
};

...
package com.water.camera.common.utils;
...
import com.water.camera.common.exif.ExifInterface;
...
public final class CameraUtil {
    ...
    public static List<String> getCamIdsByFacing(boolean isBack, Context context) {
        ...
        if (cameraNum > 0) {
            for (int i = 0; i < cameraNum; i++) {
                ...
                LogHelper.d(TAG, "[getCamIdsByFacing] i =  " + i + ",facing = " + facing);
            }
        }
        return ids;
    }
    ...
    public static void launchCamera(Activity activity) {
        ...
        String defaultMode = "com.water.camera.common.mode.photo.PhotoMode";
        String cameraId = "0";

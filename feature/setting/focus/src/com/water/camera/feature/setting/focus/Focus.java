 ...
 */
package com.water.camera.feature.setting.focus;
...
import com.water.camera.common.utils.CoordinatesTransform;
import com.water.camera.common.utils.Size;
import com.water.camera.feature.setting.focus.IFocusController.AutoFocusState;
import com.water.camera.feature.setting.focus.IFocusView.FocusViewState;
...
public class Focus extends SettingBase implements
    ...
    private String mCurrentMode = "com.water.camera.common.mode.photo.PhotoMode";
    ...
    public boolean onLongPress(float x, float y) {
        ...
        mModeHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (mCurrentMode.equals("com.water.camera.feature.mode.panorama.PanoramaMode")) {
                    return;
                }
                if (mCurrentMode.contains("com.water.camera.feature.mode.pip")) {
                    return;
                }

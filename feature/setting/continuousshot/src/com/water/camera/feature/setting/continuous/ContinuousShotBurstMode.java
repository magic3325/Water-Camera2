...
import com.water.camera.common.mode.photo.device.CaptureSurface;
import com.water.camera.common.setting.ICameraSetting.ICaptureRequestConfigure;
import com.water.camera.common.setting.ISettingManager;
import com.water.camera.common.utils.CameraUtil;
import com.water.camera.feature.setting.continuous.CsState.State;
...
public class ContinuousShotBurstMode extends ContinuousShotBase implements ICaptureRequestConfigure,
    ...
    private static final int MAX_BURST_NUM = 20;

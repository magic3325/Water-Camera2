...
public class ContinuousShotEntry extends FeatureEntryBase {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        int pla = SystemProperties.getInt("vendor.mtkcamapp.cshot.platform", 0);
//@water del debug
//        if (pla == -1 && ActivityManager.isLowRamDeviceStatic()) {
...
//        }
    ...
    public Object createInstance() {
        int version = SystemProperties.getInt("vendor.mtkcamapp.cshot.version", 0);
